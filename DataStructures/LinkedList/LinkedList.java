...
public class LinkedList {
    // Node class is something which our LinkedList class will have internally. it's
    ...
    public LinkedList alternativeAddTwoNumbers(LinkedList l1, LinkedList l2) {
    ...
    public Node getIntersectionNode(LinkedList l1, LinkedList l2) {
        if (l1 == null || l2 == null)
            return null;
    ...
    public LinkedList reverseInKGroups(LinkedList l, int k) {
        var node = l.first;
    ...
    public boolean isPalindrome(LinkedList l) {
        ...
        // reverse right half of the LinkedList
    ...
    public void swap(LinkedList list1, LinkedList list2) {
        var temp = list1;
        list1 = list2;
        list2 = temp;
    }
